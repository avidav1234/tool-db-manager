...
def _cimatron_fast_path(df, nome_file, log):
    ...
    if not records and nome_match >= 4:
        NOMI_MAP = {
            ...
            'Sito':'sito_web', 'Sito web':'sito_web',
            'Numero Ut.':'num_magazzino', 'N. Mag.':'num_magazzino',
            ...
            'Conico':'conico', 'Angolo Conicit\u00e0':'angolo_conico_gradi',
            ...
            'Nome Pinza':'nome_pinza', 'Lunghezza Presa':'lungh_presa_mm',
        ...
        TIPO_N = {'diametro_mm':'float','raggio_punta_mm':'float','angolo_punta_gradi':'float',
