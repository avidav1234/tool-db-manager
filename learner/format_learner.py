...
MASTER_FIELDS = {
    ...
    'nome_pinza':         {'label': 'Nome portautensile / pinza',         'tipo': 'string',
                           ...
                           'esempio': 'HSK63A_D10'},
    # --- Campi aggiunti per schema DB completo ---
    'sito_web':              {'label': 'URL scheda tecnica',              'tipo': 'string',
                              'keywords': ['sito','url','web','link','scheda'], 'esempio': 'https://...'},
    'num_magazzino':         {'label': 'Posizione magazzino',             'tipo': 'int',
                              'keywords': ['magazzino','magazine','pos','slot','numero'], 'esempio': '12'},
    'lunghezza_tagl2_mm':    {'label': 'Lunghezza tagliente 2 [mm]',      'tipo': 'float',
                              'keywords': ['lungh tagliente','cut length','lungh. tagliente'], 'esempio': '22.0'},
    'conico':                {'label': 'Flag conico',                     'tipo': 'int',
                              'keywords': ['conico','taper','conicita'], 'esempio': '0'},
    'angolo_conico_gradi':   {'label': 'Angolo conicita [gradi]',         'tipo': 'float',
                              'keywords': ['angolo conico','taper angle','conicita'], 'esempio': '3.5'},
    'diam_stelo_mm':         {'label': 'Diametro stelo [mm]',             'tipo': 'float',
                              'keywords': ['stelo','gambo','shank','schaft'], 'esempio': '10.0'},
    'diam_stelo_sup_mm':     {'label': 'Diametro stelo sup [mm]',         'tipo': 'float',
                              'keywords': ['stelo sup','shank top'], 'esempio': '10.0'},
    'diam_stelo_inf_mm':     {'label': 'Diametro stelo inf [mm]',         'tipo': 'float',
                              'keywords': ['stelo inf','shank bot'], 'esempio': '8.0'},
    'lungh_cono_stelo_mm':   {'label': 'Lunghezza cono stelo [mm]',       'tipo': 'float',
                              'keywords': ['cono stelo','taper length'], 'esempio': '5.0'},
    'lungh_libera_stelo_mm': {'label': 'Lunghezza libera stelo [mm]',     'tipo': 'float',
                              'keywords': ['libera stelo','free length'], 'esempio': '25.0'},
    'angolo_cono_stelo_gradi': {'label': 'Angolo cono stelo [gradi]',     'tipo': 'float',
                              'keywords': ['angolo cono stelo'], 'esempio': '5.0'},
    'lungh_presa_mm':        {'label': 'Lunghezza presa [mm]',            'tipo': 'float',
                              'keywords': ['presa','grip','einspannlaenge'], 'esempio': '25.0'},
    'avanzamento_default':   {'label': 'Avanzamento Vf [mm/min]',         'tipo': 'float',
                              'keywords': ['avanz','vf','feed','vorschub','avanzamento'], 'esempio': '2000.0'},
    'rotazione_default':     {'label': 'Rotazione [RPM]',                 'tipo': 'float',
                              'keywords': ['rotaz','rpm','drehzahl','spindle'], 'esempio': '8000.0'},
    'vita_utensile':         {'label': 'Vita utensile',                   'tipo': 'int',
                              'keywords': ['vita','life','standzeit'], 'esempio': '60'},
    'dir_rotazione':         {'label': 'Direzione rotazione',             'tipo': 'string',
                              'keywords': ['dir rotaz','cw','ccw','rotation'], 'esempio': 'CW'},
    'refrigerante':          {'label': 'Refrigerante',                    'tipo': 'string',
                              'keywords': ['refrig','coolant','kuehlmittel'], 'esempio': 'THROUGH'},
