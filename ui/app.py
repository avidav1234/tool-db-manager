...
<div style="display:grid;grid-template-columns:auto 1fr;gap:1.25rem;margin-bottom:1.25rem">
  ...
  <div>
    ...
    <div class="card" style="border-left:4px solid #1a6e35">
      ...
      <table style="font-size:12px">
      <thead><tr><th>Seg.</th><th> inf (mm)</th><th> sup (mm)</th><th>Lungh. (mm)</th></tr></thead>
      <tbody>
            ...
            try:
                ...
                if _detected == 'hypermill':
                    ...
                    try:
                        ...
                        # Non  JSON  prova come CSV generico (tab/comma separated dentro .js)
...
def dettaglio_utensile(uid):
    ...
    try:
        ...
        geos = conn.execute("SELECT tipo, elementi_json FROM geometria_fresa WHERE utensile_id=? AND tipo IN ('profilo_gambo','profilo_taglio') ORDER BY tipo", (uid,)).fetchall()
        _profilo_g = _profilo_t = None
        for g in geos:
        ...
        svg_fresa = render_fresa_svg(
            ...
            shaft_chamfer_pos_mm=u.get('shaft_chamfer_pos_mm'),
            chamfer_angle_gradi=u.get('chamfer_angle_gradi'),
            elementi_taglio=_profilo_t,
            elementi_gambo=_profilo_g)
    except Exception as e:
  ...
  <form method="post">
    <div class="card" style="height:100%">
      ...
      <p style="font-size:12px;color:#666;margin:0 0 1rem">
        ...
        Verifica se <code>Radiusdiametro_mm</code>, <code>Gaugefuori_pinza_mm</code>, ecc.
...
# =======================================================================
# CHAT WIDGET FLOTTANTE  iniettato in ogni pagina HTML
# =======================================================================
