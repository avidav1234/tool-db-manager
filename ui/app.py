...
def widget_js():
    ...
    js = (
        ...
        "  var el=document.createElement('div');"
        "  el.id=id;"
        "  var bg='background:#0f172a;color:#e2e8f0';"
        "  if(t==='u')bg='background:#1d4ed8;color:#fff;align-self:flex-end;border-radius:10px 10px 2px 10px';"
        "  else if(t==='a')bg='background:#0f172a;color:#e2e8f0;align-self:flex-start;border-radius:10px 10px 10px 2px';"
        "  else if(t==='s')bg='background:#0d2d1a;color:#86efac;align-self:center;border-radius:12px';"
        "  else if(t==='e')bg='background:#450a0a;color:#fca5a5;align-self:flex-start';"
        "  else if(t==='t')bg='color:#475569;font-style:italic;align-self:flex-start';"
        "  el.style.cssText=bg+';font-size:.8rem;line-height:1.5;padding:.55rem .75rem;max-width:95%;white-space:pre-wrap;word-break:break-word;margin-bottom:2px';"
        "  el.textContent=txt||'';"
        "  ms.appendChild(el);"
        "  el.scrollIntoView({behavior:'smooth',block:'end'});"
        "  return id;"
