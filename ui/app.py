    ...
    <div class="card">
      ...
      <form method="post" action="/importa" enctype="multipart/form-data">
        <label class="drop-zone" for="file_input" id="dz">
          ...
          <div style="font-size:12px;color:#aaa;margin-top:.4rem">Cimatron (.csv .zip .xls) ÃÂÃÂ· Hypermill (.db) ÃÂÃÂ· Mastercam (.tooldb) ÃÂÃÂ· Fusion 360 (.tools .json) ÃÂÃÂ· WorkNC (.wkz .js) ÃÂÃÂ· CSV/Excel generico</div>
...
<div style="display:grid;grid-template-columns:auto 1fr;gap:1.25rem;margin-bottom:1.25rem">
  ...
  <div>
    ...
    <div class="card" style="border-left:4px solid #1a6e35">
      ...
      <table style="font-size:12px">
      <thead><tr><th>Seg.</th><th>ÃÂÃÂ inf (mm)</th><th>ÃÂÃÂ sup (mm)</th><th>Lungh. (mm)</th></tr></thead>
      <tbody>
    ...
    if request.method == 'POST':
        ...
        if f and f.filename:
            ...
            try:
                ...
                # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Auto-detect formato ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
                ...
                # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Esegui import per formato rilevato ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
                if _detected == 'hypermill':
                    ...
                    try:
                        ...
                        # Non ÃÂÃÂ¨ JSON ÃÂ¢ÃÂÃÂ prova come CSV generico (tab/comma separated dentro .js)
